...
RequestLogAnalyzer::FileFormat.load(:rails)

class RequestLogAnalyzer::FileFormat::RailsOink < RequestLogAnalyzer::FileFormat::Rails
  ...
  # override the default Request class for this file format
